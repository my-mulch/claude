...
export default jest.suite(function () {
    ...
    jest.expect(T.astype(bb.ComplexFloat32)).toEqual([["2.00+0.00i", "6.00+0.00i"], ["1.00+0.00i", "6.00+0.00i"], ["5.00+0.00i", "2.00+0.00i"], ["1.00+0.00i", "2.00+0.00i"], ["1.00+0.00i", "5.00+0.00i"]])
    jest.expect(T.astype(bb.ComplexFloat32).astype(bb.Float32)).toEqual([["2.00", "6.00"], ["1.00", "6.00"], ["5.00", "2.00"], ["1.00", "2.00"], ["1.00", "5.00"]])
