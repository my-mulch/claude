...
export default class GraphicsEngine3D {
    ...
    zoom(zoomOut) {
        ...
        this.hud.context.fillText(`loc | r: ${Math.round(this.config.FROM_VECTOR.data.real[0] * 255)} g: ${Math.round(this.config.FROM_VECTOR.data.real[1] * 255)}, b: ${Math.round(this.config.FROM_VECTOR.data.real[2] * 255)}`, 10, 70)
