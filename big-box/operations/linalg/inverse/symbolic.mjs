...
export default function () {
    return new Function('args', [
        ...
        `if(Math.abs(er) < 1e-5 && Math.abs(ei < 1e-5)){
            ...
            ei = copy.data[1 + ${symIndex({ arrayName: 'copy', indices: ['i', 'i'] })}]
        }`,
        ...
        assignment.middle({
            ...
            withImag: `copy.data[1 + ${symIndex({ arrayName: 'copy', indices: ['i', 'j'] })}]`,
        ...
        division.middle({
            ...
            resultImag: `copy.data[1 + ${symIndex({ arrayName: 'copy', indices: ['i', 'j'] })}]`,
        }),


        assignment.middle({
            withReal: `args.result.data[${symIndex({ arrayName: 'args.result', indices: ['i', 'j'] })}]`,
            withImag: `args.result.data[1 + ${symIndex({ arrayName: 'args.result', indices: ['i', 'j'] })}]`,
            resultReal: `var tempReal`,
            resultImag: `var tempImag`,
        }),
        ...
        division.middle({
            ...
            resultImag: `args.result.data[1 + ${symIndex({ arrayName: 'args.result', indices: ['i', 'j'] })}]`,
        }),
        ...
        `ei = copy.data[1 + ${symIndex({ arrayName: 'copy', indices: ['ii', 'i'] })}]`,
        ...
        subtraction.middle({
            ...
            ofImag: `copy.data[1 + ${symIndex({ arrayName: 'copy', indices: ['ii', 'j'] })}]`,
            withReal: `elimCopyReal`,
            withImag: `elimCopyImag`,
            resultReal: `copy.data[${symIndex({ arrayName: 'copy', indices: ['ii', 'j'] })}]`,
            resultImag: `copy.data[1 + ${symIndex({ arrayName: 'copy', indices: ['ii', 'j'] })}]`,
        }),
        ...
        subtraction.middle({
            ...
            ofImag: `args.result.data[1 + ${symIndex({ arrayName: 'args.result', indices: ['ii', 'j'] })}]`,
            withReal: `elimResultReal`,
            withImag: `elimResultImag`,
            resultReal: `args.result.data[${symIndex({ arrayName: 'args.result', indices: ['ii', 'j'] })}]`,
            resultImag: `args.result.data[1 + ${symIndex({ arrayName: 'args.result', indices: ['ii', 'j'] })}]`,
        }),
