...
export default jest.suite(function () {
    ...
    E = bb.tensor([
        ...
        ['1 + 1i', '10 + 10i', '100 + 100i'],
        ['1 + 1i', '10 + 10i', '100 + 100i'],
        ['1 + 1i', '10 + 10i', '100 + 100i']], bb.ComplexInt32)
    ...
    const L = bb.arange(0, 1, 100, bb.Float32)
    ...
    this.expect(bb.max(A, bb.NULL, bb.zeros([1], bb.Int32), { axes: [0, 1, 2, 3] })).toEqual(["44"])
    ...
    this.expect(bb.sub(B, B, bb.zerosLike(B))).toEqual(bb.zeros(B.shape, bb.Int32))
    this.expect(bb.min(C.slice([':', 0, ':']), bb.NULL, bb.zeros([[1]], bb.Int32), { axes: [0, 1] })).toEqual(["1"])
    this.expect(bb.div(C.slice([':', 0, ':']), C.slice([':', 0, ':']), bb.zeros([3, 3], bb.Int32))).toEqual([["1", "1", "1"], ["1", "1", "1"], ["1", "1", "1"]])
    this.expect(bb.mean(B, bb.NULL, bb.zeros([4], bb.Float32), { axes: [1] })).toEqual(["-13.5", "-14.5", "-3", "-29"])
    this.expect(bb.mean(B, bb.NULL, bb.zeros([2], bb.Int32), { axes: [0] })).toEqual(["-25", "-5"])
