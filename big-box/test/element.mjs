...
export default jest.suite(function () {
    ...
    const L = bb.arange({ stop: 100, type: bb.Int32 })
    ...
    const R = bb.zeros({ shape: [2, 3], type: bb.Int32 })
    bb.min({ of: A, result: R, axes: [0, 3] })
    this.expect(R).toEqual([["17", "21", "-15"], ["-2", "-13", "-5"]])
